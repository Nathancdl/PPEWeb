          ...
          <div class='card blue-grey darken-1'>
			...
			<div id="modal<?php echo $i; ?>" class="modal">
				<div class="modal-content">
					<h4>Proposer cette formation</h4>
					<p>Souhaitez-vous réelement proposer cette formation a vos salariés ?</p>
					<p>
				...
				<div class="modal-footer">
					<a href="#"
						...
						<a href="index.php?page=nouvellesformationschef&idformation=<?php echo $formation['idformation']; ?>"
