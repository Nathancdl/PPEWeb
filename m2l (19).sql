...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 24 Mars 2017 à 10:14
...
INSERT INTO `formation` (`idformation`, `contenu`, `date_debut`, `date_fin`, `nb_jour`, `prerequis`, `numero`, `rue`, `idcommune`, `idprestataire`, `idtypeFormation`) VALUES
(1, 'yolo', '2016-12-29', '0000-00-00', 2, 'bts', 78, 'albert sarraut', 1, 2, 1),
(2, 'yolal', '2016-12-29', '0000-00-00', 3, 'bts +3', 74, 'albert sarral', 2, 2, 2),
(14, 'jambon', '2017-01-31', '0000-00-00', 8, 'aoiudoi', 87, 'avenue albert sarraut', 81, 2, 39),
(15, 'Formation de excel pour camille', '2017-02-03', '0000-00-00', 3, 'Avoir excel', 87, 'avenue albert sarraut', 1, 2, 1),
(16, 'Formation HTML', '2017-02-25', '0000-00-00', 2, 'BAC ', 87, 'Avenue du Bourg Palette', 77, 2, 1),
(17, 'OMGA', '2017-03-02', '0000-00-00', 2, 'Aucun', 66, 'Rue de la paix', 77, 2, 40),
(23, 'dzadaoj', '2017-03-18', '0000-00-00', 12, 'azda', 12, 'daz', 93, 23, 47),
(24, 'LEL', '2017-03-18', '0000-00-00', 12, 'aucun', 22, 'rue de champs', 95, 24, 48),
(25, 'ababa', '2017-03-25', '0000-00-00', 2, 'aucu', 66, 'rue', 96, 2, 49),
(26, 'ababaa', '2017-03-25', '0000-00-00', 2, 'aucue', 64, 'rueae', 97, 2, 50);
...
INSERT INTO `message` (`idmessage`, `message`, `date_msg`, `idsalarie`, `channel`) VALUES
